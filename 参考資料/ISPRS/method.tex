...
($0\le s < r$).
Let $\theta_w$ and $\theta_a$ denote, respectively, the incidence and
...
\begin{equation}
  \frac{d\theta_w}{d\theta_a}
  =\frac{1}{n}\frac{\cos\theta_a}{\cos\theta_w} 
...
\begin{empheq}[left=\empheqlbrace]{align}
    ...
    z' &= \frac{1}{n}\left(\frac{\cos\theta_a}{\cos\theta_w}\right)^{3} z. \label{eq:z'}
\end{empheq}
\end{subequations}

Because $z<0$ and $\theta_a>\theta_w$, these relations guarantee
