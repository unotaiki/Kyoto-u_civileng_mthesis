...
こうした課題は、少子高齢化による作業員の不足や、河川管理に面的な管理が求められるている状況も鑑みて、
...
ドローン空中写真測量により、サンゴ礁など浅水域の高解像度三次元モデルと色情報を同時に取得できる。こうしたデータは、底生生物群集の多様性や経時的な変化を定量評価する基盤情報となり、広域マッピングや生息地モニタリングにも有用である\cite{Joyce2018_Drone-marine-survey_and_how-to}。
