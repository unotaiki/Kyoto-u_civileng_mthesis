...
エコトーン(Ecotone)とは、二つの異なる環境の境界･移行帯を指す概念である。
Wikiには、``two plant communities''と紹介されていたよ。
近年、生物多様性のHotspotだったり、人間社会の憩いの場だったりで、より重要視される概念だよ。
陸域と水域の境界においては、エコトーンは浅水域となるよ。
エコトーンとなる浅水域では、光が底まで届き、エネルギーが供給され植生が存在し、生態系が豊かだよ。
\note{ここで、光が辺り水底まで届く浅水域と制限できるのは、Photogrammetric Bathymetryにおける水底が視認可能であるという制約と合致、研究のLimitationを軽減できるよ}
生態系を把握したり、聖牛をおいて、それが植生に影響を与えたり確認したり、防災の観点からもエコトーンとなる地点をマネジメントするには、水底の三次元形状を把握する必要があるよ。

しかし、以下の理由で浅水域の三次元計測は難しいよ。

\missingfigure{ecotoneの概念が分かるような参考の写真。陸から川底を取った写真(植生付き)、海岸線やサンゴ礁。(海の写真とかはどこから引用するんだろう)}
...
\kobayashi{気体－液体屈折について。これも既に書いてある内容で大丈夫だと思います。また、ここからは方法でも詳しく説明する部分なので、イントロでどこまで書くか。浅水域の写真測量において克服すべき点の１つであること、屈折とはどういう現象か、これまで写真測量でどういう風に対処されてきたか、測量を向上するために何が足りないか・何を考えるべきか}
