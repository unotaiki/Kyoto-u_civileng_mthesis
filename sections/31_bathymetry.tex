...
\subsection{Satellite Derived Bathymetry}\label{subsec:bg_sdb} 
...
UAVにより空撮された多視点画像から、詳細を後述するStructure-from-Motion (SfM) (\cref{subsec:sfm}) および Multi-View Stereo (MVS) (\cref{subsec:mvs}) を用いて3次元形状を復元するアプローチは、陸部においては既に広い用途で実用化されている\cite{Bemis2014_UAV-photogrammetry,Gomez2016_UAV-photogrammetry-disaster,Iglhaut2019_UAV-photogrammetry-forestry}。
