...
\iffalse % (下記は旧下書き：記号が不整合なため無効化)
= \frac{\partial (r', z')}{\partial (r, z)} = \begin{pmatrix} \frac{\partial r'}{\partial r} & \frac{\partial r'}{\partial z} \\ \frac{\partial z'}{\partial r} & \frac{\partial z'}{\partial z} \end{pmatrix}

\\
 =
\begin{pmatrix}
\displaystyle 
1 + \frac{3(n^2 - 1) z \tan^2 \theta_r \sec^2 \theta_r}{\Delta}
& 
\displaystyle 
(n^2 - 1) \tan^3 \theta_r \left( 1 + \frac{3 z \sec^2 \theta_r}{\Delta} \right) 

\\[1.5em]

\displaystyle 
\frac{3 z' \tan \theta_r}{\Delta} \left( 1 - n^2 \gamma^2 \right)
& 
\displaystyle 
\frac{z'}{z} + \frac{3 z' \tan^2 \theta_r}{\Delta} \left( 1 - n^2 \gamma^2 \right)
\end{pmatrix}
\fi