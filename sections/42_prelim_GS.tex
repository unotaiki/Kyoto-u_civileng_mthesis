...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{figure/40_prelim/3dgs_pipeline.png}
  \caption{
...
\missingfigure{Regularizationの効果を表す図を2DGSから引用}
...
これらの幾何学的制約により、2DGSはノイズの少ない詳細なメッシュ抽出が可能となり、かつ3DGSと同等のレンダリング速度と画質を維持している。
