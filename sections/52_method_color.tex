...
Snellの法則（式\cref{eq:snell}）およびその微分式\cref{}より、以下の関係式が導かれる。
\begin{equation}
  n^2 \cos \theta_i \sin \theta_i d \theta_i = n^2 \cos \theta_r \sin \theta_r d \theta_r
\end{equation}
ここで、微小面積要素$dA$および方位角の微小変化$d\psi$を考慮し、微小立体角$d\omega = \sin\theta d\theta d\psi$との関係を用いると、エテンデュ保存則\parencite{etendue}として知られる以下の関係が得られる。
